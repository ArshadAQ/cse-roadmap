<?php
     ...
     */
    function render($view, $view1 , $view2, $view3 = NULL, $values = [])
    {
        ...
        if (file_exists("../views/{$view}"))
        {
           ...
           // if($view !== "history_form.php" && $view !== "history_form_1.php")
            ...
            if($view == "history_form.php")
                require("../views/middle_course.php");
            else if($view == "history_form_1.php")
            {
                require("../views/middle_bookmark.php");
                //require("../views/middle_sbookmark.php");
            }
            else
                require("../views/footer.php");
            if($view2 !== NULL)
